...
intent_classifier = Agent(
    ...
    Respond with just the category word, nothing else — no punctuation, no explanation. after intent classification return to Orchestrator with intent then to response_generator""",
